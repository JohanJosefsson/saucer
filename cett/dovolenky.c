...
#define PICTURE_FLICKER_SLOWDOWN    5
#define INITIAL_X                   10
#define INITIAL_Y                    2
#define X_MOVE_SLOWDOWN              3
#define Y_MOVE_SLOWDOWN             3
#define DX_CHANGE_SLOWDOWN          30
#define DY_CHANGE_SLOWDOWN          20
#define NOF_PICS                     3
#define INITIAL_CNT                  7
#define BOUNCE_BACK                  1
...
struct Level monster_dovolenky =
{
	IDB_BACKGROUND_DOVOLENKY,
	IDB_MONSTER_DOVOLENKY,
	IDB_OBSTACLE,
	Monster_new,
	Monster_delete,
	Monster_isPos,
