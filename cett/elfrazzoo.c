#if 0
#define PICTURE_FLICKER_SLOWDOWN    25
#define INITIAL_X                   10
#define INITIAL_Y                    2
...
#define PICTURE_FLICKER_SLOWDOWN    9
#define INITIAL_X                   10
#define INITIAL_Y                    2
#define X_MOVE_SLOWDOWN              4
#define Y_MOVE_SLOWDOWN             3
#define DX_CHANGE_SLOWDOWN          50
#define DY_CHANGE_SLOWDOWN          60
#define NOF_PICS                     7
#define INITIAL_CNT                  2
#define BOUNCE_BACK                  1
...
static void Monster_new(void) {
	...
	srand ( time(NULL) );
	me->cnt = INITIAL_CNT;
	getObstacles(obstacles, 20 , 4, 4, 41, 21);
}
...
struct Level monster_elfrazzoo =
{
	IDB_BACKGROUND_ELFRAZZOO,
	IDB_MONSTER_ELFRAZZOO,
	IDB_OBSTACLE,
	Monster_new,
	Monster_delete,
	Monster_isPos,
